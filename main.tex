...
% copy pasted tikz stuff
%\tikzset{doohicky/.pic={%
%\fill[color=black,rounded corners] (-15pt,-11pt) rectangle (15pt,-1pt);
%\fill[color=white] (-10pt,-6pt) circle[radius=4pt]
                    %(0pt,-6pt) circle[radius=4pt]
                    %(10pt,-6pt) circle[radius=4pt];
%}}

\tikzset{vec/.pic={%
\fill[color=black,rounded corners] (-11pt,-15pt) rectangle (-1pt,15pt);
\fill[color=white] (-6pt,-10pt) circle[radius=4pt]
                   (-6pt,0pt) circle[radius=4pt]
                   (-6pt,10pt) circle[radius=4pt];
}}
...
\node [doc] (A) {Story 1};
\node [doc, below=of A] (B) {Story 2};
\node [doc, below=of B] (C) {Story 3};

\draw (A.east) ++ (5em,0) pic{vec};
\draw (A.east) ++ (6.5em,0) pic{vec};
\draw (A.east) ++ (8em,0) pic{vec};
\draw (A.east) ++ (9.5em,0) pic{vec};

\draw (B.east) ++ (5em,0) pic{vec};
\draw (B.east) ++ (6.5em,0) pic{vec};
\draw (B.east) ++ (8em,0) pic{vec};

\draw (C.east) ++ (5em,0) pic{vec};
\draw (C.east) ++ (6.5em,0) pic{vec};
\draw (C.east) ++ (8em,0) pic{vec};
\draw (C.east) ++ (9.5em,0) pic{vec};
\draw (C.east) ++ (11em,0) pic{vec};

\draw[ultra thick] (A.east) ++ (15em,0) -- +(2em,0);
\draw[ultra thick] (A.east) ++ (18em,0) -- +(2em,0);
\draw[ultra thick] (A.east) ++ (24em,0) -- +(2em,0);
\draw[ultra thick] (A.east) ++ (27em,0) -- +(2em,0);

\draw[ultra thick] (B.east) ++ (15em,0) -- +(2em,0);
\draw[ultra thick] (B.east) ++ (18em,0) -- +(2em,0);
\draw[ultra thick] (B.east) ++ (24em,0) -- +(2em,0);

\draw[ultra thick] (C.east) ++ (15em,0) -- +(2em,0);
\draw[ultra thick] (C.east) ++ (21em,0) -- +(2em,0);
\draw[ultra thick] (C.east) ++ (24em,0) -- +(2em,0);
\draw[ultra thick] (C.east) ++ (30em,0) -- +(2em,0);
\draw[ultra thick] (C.east) ++ (33em,0) -- +(2em,0);


\end{tikzpicture}
\caption{
\label{fig:storyintro}
Caption
}
\end{figure}
