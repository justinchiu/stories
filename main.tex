...
An example of a storyline motif would be a sequence of sentences that finishes 
introducing characters and setting the story,
signalling the end of introduction and the start of the
...
and also obtaining annotations from humans, both of which are expensive.
