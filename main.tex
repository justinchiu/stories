...
These black-box text generation models may not be satisfactory in all scenarios,
especially when coherent long-form generations are desired.
In such scenarios, a model with explicit hierarchical structure would be more suitable,
as the structure would afford controllability.
...
\citep{yao2018storyline,fan2019structure,ippolito2019rarewords}.
...
% What are motifs
Biological sequence motifs are recurring patterns that are believed to have
...
A storyline motif may consist of a sequence of sentences that finishes introducing the
reader to the setting, signalling the end of introduction and the start of the
rising action to the reader.

% Avoid getting interpretation supervision by turning to alignment
Ideally, we would obtain manually labeled storyline motifs from humans,
...
It would require both designing an experimental procedure for the labeling
and obtaining annotations.
